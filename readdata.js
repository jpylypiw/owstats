...
function correctGameStats(list) {
    ...
    return new Promise(async function(resolve, reject) {
        if (list.hasOwnProperty("recon_assist_most_in_game")) list = await renameJsonKey([list, "recon_assist_most_in_game", "recon_assists_most_in_game"]);
        if (list.hasOwnProperty("shield_generator_destroyed_most_in_game")) list = await renameJsonKey([list, "shield_generator_destroyed_most_in_game", "shield_generators_destroyed_most_in_game"]);
        if (list.hasOwnProperty("recon_assist")) list = await renameJsonKey([list, "recon_assist", "recon_assists"]);
        if (list.hasOwnProperty("teleporter_pad_destroyed_most_in_game")) list = await renameJsonKey([list, "teleporter_pad_destroyed_most_in_game", "teleporter_pads_destroyed_most_in_game"]);
        if (list.hasOwnProperty("environmental_kill_most_in_game")) list = await renameJsonKey([list, "environmental_kill_most_in_game", "environmental_kills_most_in_game"]);
        if (list.hasOwnProperty("shield_generator_destroyed")) list = await renameJsonKey([list, "shield_generator_destroyed", "shield_generators_destroyed"]);
        if (list.hasOwnProperty("melee_final_blow_most_in_game")) list = await renameJsonKey([list, "melee_final_blow_most_in_game", "melee_final_blows_most_in_game"]);
        ...
        if (list.hasOwnProperty("teleporter_pad_destroyed")) list = await renameJsonKey([list, "teleporter_pad_destroyed", "teleporter_pads_destroyed"]);
        ...
        if (list.hasOwnProperty("turret_destroyed_most_in_game")) list = await renameJsonKey([list, "turret_destroyed_most_in_game", "turrets_destroyed_most_in_game"]);
        ...
        if (list.hasOwnProperty("elimination_most_in_life")) list = await renameJsonKey([list, "elimination_most_in_life", "eliminations_most_in_life"]);
        ...
        if (list.hasOwnProperty("critical_hit_most_in_life")) list = await renameJsonKey([list, "critical_hit_most_in_life", "critical_hits_most_in_life"]);
        if (list.hasOwnProperty("objective_kill_most_in_game")) list = await renameJsonKey([list, "objective_kill_most_in_game", "objective_kills_most_in_game"]);
        ...
        if (list.hasOwnProperty("offensive_assist_most_in_game")) list = await renameJsonKey([list, "offensive_assist_most_in_game", "offensive_assists_most_in_game"]);
        if (list.hasOwnProperty("turret_kill_most_in_game")) list = await renameJsonKey([list, "turret_kill_most_in_game", "turret_kills_most_in_game"]);
        if (list.hasOwnProperty("critical_hit_most_in_life")) list = await renameJsonKey([list, "critical_hit_most_in_life", "critical_hits_most_in_life"]);
        if (list.hasOwnProperty("elimination_most_in_game")) list = await renameJsonKey([list, "elimination_most_in_game", "eliminations_most_in_game"]);
        if (list.hasOwnProperty("defensive_assist_most_in_game")) list = await renameJsonKey([list, "defensive_assist_most_in_game", "defensive_assists_most_in_game"]);
        if (list.hasOwnProperty("critical_hit_most_in_game")) list = await renameJsonKey([list, "critical_hit_most_in_game", "critical_hits_most_in_game"]);
        if (list.hasOwnProperty("critical_hit")) list = await renameJsonKey([list, "critical_hit", "critical_hits"]);
        if (list.hasOwnProperty("fan_the_hammer_kill_most_in_game")) list = await renameJsonKey([list, "fan_the_hammer_kill_most_in_game", "fan_the_hammer_kills_most_in_game"]);
        if (list.hasOwnProperty("self_destruct_kill_most_in_game")) list = await renameJsonKey([list, "self_destruct_kill_most_in_game", "self_destruct_kills_most_in_game"]);
        ...
        if (list.hasOwnProperty("enemy_slept_most_in_game")) list = await renameJsonKey([list, "enemy_slept_most_in_game", "enemies_slept_most_in_game"]);
        if (list.hasOwnProperty("nano_boost_applied_most_in_game")) list = await renameJsonKey([list, "nano_boost_applied_most_in_game", "nano_boosts_applied_most_in_game"]);
        if (list.hasOwnProperty("primal_rage_kill")) list = await renameJsonKey([list, "primal_rage_kill", "primal_rage_kills"]);
        if (list.hasOwnProperty("primal_rage_kill_most_in_game")) list = await renameJsonKey([list, "primal_rage_kill_most_in_game", "primal_rage_kills_most_in_game"]);
        if (list.hasOwnProperty("enemy_empd_most_in_game")) list = await renameJsonKey([list, "enemy_empd_most_in_game", "enemies_empd_most_in_game"]);
        if (list.hasOwnProperty("blaster_kill")) list = await renameJsonKey([list, "blaster_kill", "blaster_kills"]);
        if (list.hasOwnProperty("enemy_hacked_most_in_game")) list = await renameJsonKey([list, "enemy_hacked_most_in_game", "enemies_hacked_most_in_game"]);
        if (list.hasOwnProperty("blaster_kill_most_in_game")) list = await renameJsonKey([list, "blaster_kill_most_in_game", "blaster_kills_most_in_game"]);
        ...
        if (list.hasOwnProperty("projected_barrier_applied_most_in_game")) list = await renameJsonKey([list, "projected_barrier_applied_most_in_game", "projected_barriers_applied_most_in_game"]);
        if (list.hasOwnProperty("armor_pack_created_most_in_game")) list = await renameJsonKey([list, "armor_pack_created_most_in_game", "armor_packs_created_most_in_game"]);
        resolve(list);
    });
}
